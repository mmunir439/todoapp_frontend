const ur = {
  ...
  udhaar: {
    title: "ادھار کھاتہ",
    subtitle: "ادھار ریکارڈ — کس کا کتنا بقایا ہے",
    totalPending: "کل بقایا ادھار",
    customersWithBalance: "گاہکوں کا بقایا",
    udhaarWale: "ادھار والے گاہک",
    allRecords: "تمام ریکارڈ",
    allTransactions: "تمام ادھار لین دین",
    customerKhata: "{name} کا کھاتہ",
    recordWasool: "وصول درج کریں",
    noEntries: "کوئی entry نہیں",
    allClear: "سب صاف — کوئی ادھار نہیں!",
    paymentRecorded: "ادائیگی درج ہو گئی!",
    newUdhaarSale: "نئی ادھار فروخت",
    addUdhaarSale: "ادھار فروخت شامل کریں",
    currentBalance: "موجودہ بقایا",
    totalCredit: "کل ادھار دیا",
    totalPaid: "کل وصول",
    remaining: "باقی",
    balanceAfter: "بعد بقایا",
    todayOnly: "صرف آج",
    filter: {
      all: "سب",
